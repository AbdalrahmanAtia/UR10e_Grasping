...
class ImageSubscriber(Node):
    def __init__(self):
        ...
        # Our D455 camera intrinsic parameters (from our calibration results my_ur_driver/config/results.json)
        self.fx, self.fy =   642.4262770792711, 642.3461744750167,
        self.cx, self.cy =   647.5434733474444, 373.3602344467871
        self.scale = 1000.0  # Scale for depth image conversion

        # Set our workspace limits for point cloud filtering (to be adjusted)
        ...
        # Use this if launched the default camera launch file 
        ...
        # Use this if launched my custom camera launch file 
        self.color_subscriber = Subscriber(self, Image, '/Realsense_D455/color/image_raw')
        self.depth_subscriber = Subscriber(self, Image, '/Realsense_D455/aligned_depth_to_color/image_raw')
        ...
        self.image_count = 0
        self.save_directory = 'src/my_pkg/scripts/calibration/captured_images2'
    ...
    def listener_callback(self, color_msg, depth_msg):
        ...
        # Process and visualize the point cloud
...
## This is mainly from the anygrasp sdk/ grasp_detection /demo.py
